...
import de.ka.jamit.tcalc.ui.settings.SettingsFragment
...
class SettingsFragmentTest : FragmentTest(){

    /**
     * Edit these arguments according to the fragment you want to test.
     */
    private val fragmentClass = SettingsFragment::class.java
    private val fragmentArgs: Bundle? = Bundle().apply {}
    override var displayedViewsInFragment = listOf(R.id.wow, R.id.recyclerSettings)

...
import de.ka.jamit.tcalc.ui.settings.detail.DetailFragment
...
class DetailFragmentTest : FragmentTest(){

    /**
     * Edit these arguments according to the fragment you want to test.
     */
    private val fragmentClass = DetailFragment::class.java
    private val fragmentArgs = Bundle().apply {}
    override var displayedViewsInFragment = listOf(R.id.detail_back_button)

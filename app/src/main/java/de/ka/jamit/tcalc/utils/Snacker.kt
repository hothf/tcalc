...
import de.ka.jamit.tcalc.utils.Snacker.Companion.HIDE_TIME_MS
import de.ka.jamit.tcalc.utils.Snacker.SnackAnim
import de.ka.jamit.tcalc.utils.Snacker.SnackType
import kotlin.math.max


// Because SnackBars tend to be not that modification friendly and app often need a more branded solution to
// them, this offers a simple way of showing fully customizable SnackBars.
// This snacker can simply be edited in styling and animation by changing the layout file and modifying reveal()
// and hide()
...
class Snacker @JvmOverloads constructor(
     ...
     * snacker.
     */
    enum class SnackType(@ColorRes val textColorRes: Int,
         ...
         */
        DEFAULT(R.color.snackDefaultTextColor, R.color.snackActionTextColor, R.drawable.bg_snacker_default),
         ...
         */
        WARNING(R.color.snackWarningTextColor, R.color.snackActionTextColor, R.drawable.bg_snacker_warning),
